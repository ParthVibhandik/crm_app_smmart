                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FutureBuilder(
                              future: industriesMemoizer
                                  .runOnce(controller.loadIndustries),
                              builder: (context, list) {
                                if (list.data?.status ?? false) {
                                  return CustomDropDownTextField(
                                    ...
                                    items: controller.industriesModel.data!
                                        .map((value) {
                                      return DropdownMenuItem(
                                        value: value.name,
                              ...
                              builder: (context, list) {
                                if (list.data?.status ?? false) {
                                  return CustomDropDownTextField(
                                    ...
                                    items: controller.designationsModel.data!
                                        .map((value) {
                                      return DropdownMenuItem(
                                        value: value.id,
                                        child: Text(value.name ?? '',
                              ...
                              builder: (context, list) {
                                if (list.data?.status ?? false) {
                                  return CustomMultiSelectDropDown(
                                    ...
                                    items:
                                        controller.interestedInModel.data ?? [],
                                    initialSelectedIds:
