...
class SuspectingDetailsScreen extends StatelessWidget {
  const SuspectingDetailsScreen({super.key});
  ...
  Widget _buildDetailRow(BuildContext context, SuspectingController controller,
  ...
  Widget _buildStageDataRow(BuildContext context,
      SuspectingController controller, String key, dynamic value) {
    if (!controller.isEditing) {
