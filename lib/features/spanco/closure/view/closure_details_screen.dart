...
class ClosureDetailsScreen extends StatelessWidget {
  const ClosureDetailsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<ClosureController>(
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            title: Text('Details',
  ...
  Widget _buildDetailRow(BuildContext context, ClosureController controller,
  ...
  Widget _buildStageDataRow(BuildContext context, ClosureController controller, String key, dynamic value) {
    if (!controller.isEditing) {
