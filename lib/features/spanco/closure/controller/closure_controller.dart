...
import 'package:flutex_admin/features/spanco/closure/view/closure_details_screen.dart';
import 'package:get/get.dart';

class ClosureController extends GetxController {
  ClosureRepo repo;
  ClosureController({required this.repo});
  ...
  Future<void> onItemTap(String opportunityId) async {
    ...
    Get.to(() => const ClosureDetailsScreen());
  ...
  Future<void> updateData() async {
    ...
    print('DEBUG Closure Body Payload: $body');
    ResponseModel responseModel = await repo.updateData(body);
    print('DEBUG Closure API Response: ${responseModel.responseJson}');
