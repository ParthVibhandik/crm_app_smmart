...
import 'package:flutex_admin/features/spanco/negotiating/view/negotiating_details_screen.dart';
import 'package:get/get.dart';

class NegotiatingController extends GetxController {
  NegotiatingRepo repo;
  NegotiatingController({required this.repo});
  ...
  Future<void> onItemTap(String opportunityId) async {
    ...
    Get.to(() => const NegotiatingDetailsScreen());
