...
class NegotiatingDetailsScreen extends StatelessWidget {
  const NegotiatingDetailsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<NegotiatingController>(
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            title: Text('Details',
  ...
  Widget _buildDetailRow(BuildContext context, NegotiatingController controller,
  ...
  Widget _buildStageDataRow(BuildContext context, NegotiatingController controller, String key, dynamic value) {
    if (!controller.isEditing) {
