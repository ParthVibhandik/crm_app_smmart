            ...
            children: [
              Align(
                ...
                child: Padding(
                  ...
                  child: Text('Calendar',
                      style:
                          regularLarge.copyWith(fontWeight: FontWeight.bold)),
                ),
              ),
              TableCalendar(
                ...
                Column(
                  children: [
                    ...
                    if (dayEvents.isEmpty)
                      ...
                      ...dayEvents.whereType<AttendanceStatus>().map((e) {
                        final event = e;
                        return Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              _buildPunchInfo(
                                  'Punch In', event.punchInTime, Colors.green),
                              Container(
                                  height: 30,
                                  width: 1,
                                  color: Colors.grey[300]),
                              _buildPunchInfo(
                                  'Punch Out', event.punchOutTime, Colors.red),
                            ],
                          ),
                        );
                      }),
                        ...
                        if (event is Task) {
                          ...
                          return ListTile(
                            leading: const Icon(Icons.task_alt,
                                color: Colors.orange),
                            title: Text(event.name ?? 'Untitled Task',
                                style: mediumSmall),
                          ...
                          return ListTile(
                            leading: const Icon(Icons.notifications_active,
                                color: Colors.red),
                            title: Text(
                                event.description ?? 'Untitled Reminder',
                                style: mediumSmall),
                            subtitle: Text(
                                'Staff: ${event.staffId ?? 'Unknown'}',
                                style: regularSmall),
                            onTap: () {
                              print(
                                  'DEBUG: Tapped Reminder ${event.id}, RelType: ${event.relType}, RelId: ${event.relId}');
                              if (event.relType == 'lead' &&
                                  event.relId != null) {
                                Get.toNamed(RouteHelper.leadDetailsScreen,
                                    arguments: event.relId);
                              } else if (event.relType == 'customer' &&
                                  event.relId != null) {
